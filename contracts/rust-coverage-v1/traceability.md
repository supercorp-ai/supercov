...
| RCV-ATTRIBUTION-1 | Exact run/worker/test/retry/phase identity | Transport records a supervisor-resolved context ID per observation; process-per-libtest runner test | In-process concurrent libtest, async, retry, subprocess, crash and late-work corpus |
