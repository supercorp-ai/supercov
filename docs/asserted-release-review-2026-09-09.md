...
Follow-up: Windows compiler lookup was fixed in `408a3f2`, whose
[complete eight-target native matrix](https://github.com/supercorp-ai/supercov/actions/runs/34377618812)
